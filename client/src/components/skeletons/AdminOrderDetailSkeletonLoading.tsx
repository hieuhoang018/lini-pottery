    ...
    <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <div className="mt-2 h-4 w-56 animate-pulse rounded bg-stone-200" />
        </div>

        <div className="md:text-right">
          <div className="h-4 w-20 animate-pulse rounded bg-stone-200 md:ml-auto" />
          <div className="mt-3 h-8 w-32 animate-pulse rounded bg-stone-300" />
        </div>
      </div>
    </div>
  )
...
function CustomerTitleCardSkeleton() {
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
      <div className="h-7 w-32 animate-pulse rounded bg-stone-300" />

      <div className="mt-4 grid gap-3 md:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <div key={index}>
            <div className="h-4 w-20 animate-pulse rounded bg-stone-200" />
            <div className="mt-2 h-5 w-36 animate-pulse rounded bg-stone-200" />
          </div>
        ))}
      </div>
    </div>
...
function ShippingAddressSkeleton() {
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
      <div className="h-7 w-44 animate-pulse rounded bg-stone-300" />
...
function PaymentRecordSkeleton() {
  return (
    <div className="rounded-xl bg-stone-50 p-4">
      ...
      <div className="mt-2 h-4 w-52 animate-pulse rounded bg-stone-200" />
    </div>
  )
}
...
function ActionPanelSkeleton() {
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-stone-200">
      ...
      <div className="mt-6 h-12 w-full animate-pulse rounded-full bg-stone-200" />
    </div>
  )
}
